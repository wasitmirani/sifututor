...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    getStaffPayment: function getStaffPayment(id) {
      ...
      axios.get('/staff-payment/' + id).then(function (res) {
        _this.form = res.data.payments;
