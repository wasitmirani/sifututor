    ...
    var h = {
        ...
        _triggerWindowEvent: function (t) {
            ...
            "undefined" != typeof window &&
                (document.createEvent ? ("function" == typeof Event ? (e = new Event(t)) : (e = document.createEvent("Event")).initEvent(t, !1, !0), window.dispatchEvent(e)) : window.fireEvent("on".concat(t), document.createEventObject()));
        },
                ...
                t.forEach(function (t) {
                    t.addEventListener("click", function (e) {
                        ...
                        "text" === o.getAttribute("type")
                            ? (o.setAttribute("type", "password"), i.classList.replace("ti-eye", "ti-eye-off"))
                            : "password" === o.getAttribute("type") && (o.setAttribute("type", "text"), i.classList.replace("ti-eye-off", "ti-eye"));
                    });
                });
        },
