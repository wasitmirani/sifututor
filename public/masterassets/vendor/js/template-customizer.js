!(function () {
                        ...
                        (e.i = function (t, s, i, a, o) {
                            ...
                            for (var c = 0; c < t.length; c++) {
                                ...
                                (i && n[u[0]]) ||
                                    ...
                                    s && (u[2] ? ((u[1] = "@media ".concat(u[2], " {").concat(u[1], "}")), (u[2] = s)) : (u[2] = s)),
                ...
                function i(t, i) {
                    for (var o = {}, n = [], l = 0; l < t.length; l++) {
                        ...
                        if (-1 !== h) e[h].references++, e[h].updater(p);
                            ...
                            var m = a(p, i);
                            (i.byIndex = l), e.splice(l, 0, { identifier: d, updater: m, references: 1 });
                        }
                        n.push(d);
                    }
                    return n;
                    ...
                    return {
                        update: function (s) {
                            !(function (t, e, s) {
                                ...
                                a && (i += "@layer".concat(s.layer.length > 0 ? " ".concat(s.layer) : "", " {")), (i += s.css), a && (i += "}"), s.media && (i += "}"), s.supports && (i += "}");
                                var o = s.sourceMap;
    ...
    !(function () {
        ...
        var t = s(3379),
            ...
            m = s(7621),
            y = {};
        (y.styleTagTransform = p()), (y.setAttributes = c()), (y.insert = l().bind(null, "head")), (y.domAPI = o()), (y.insertStyleElement = d()), e()(m.Z, y), m.Z && m.Z.locals && m.Z.locals;
        var f =
                    ...
                    (s = [
                            ...
                            value: function (t) {
                                ...
                                if (this._hasControls("themes")) {
                                    ...
                                    if (i) {
                                        ...
                                        this._loadStylesheets(g({}, a, document.querySelector(".template-customizer-theme-css")), s || function () {}), e && this.settings.onSettingsChange.call(this, this.settings);
                                    }
                                }
                            },
                        },
                            ...
                            value: function () {
                                if (!this._ssr) {
                                    ...
                                    this._controls.layoutMenuFlipped &&
                                        (e
                                            ? (this._controls.layoutMenuFlipped.removeAttribute("disabled"), this._controls.layoutMenuFlipped.classList.remove("disabled"))
                                            : (this._controls.layoutMenuFlipped.setAttribute("disabled", "disabled"), this._controls.layoutMenuFlipped.classList.add("disabled"))),
                                        ...
                                        this._controls.layoutNavbarFixed &&
                                            (t
                                                ? (this._controls.layoutNavbarFixed.removeAttribute("disabled"), this._controls.layoutNavbarFixedW.classList.remove("disabled"))
                                                : (this._controls.layoutNavbarFixed.setAttribute("disabled", "disabled"), this._controls.layoutNavbarFixedW.classList.add("disabled")),
                                            s && t && "fixed" == this.settings.layoutType && (this._controls.layoutNavbarFixed.setAttribute("disabled", "disabled"), this._controls.layoutNavbarFixedW.classList.add("disabled"))),
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                o.addEventListener("click", n), this._listeners.push([o, "click", n]);
                            ...
                            value: function () {
                                if (this._hasControls("themes"))
                                    this._insertStylesheet(
                                        ...
                                        this.pathResolver(this.settings.themesPath + this.settings.cssFilenamePattern.replace("%name%", this.settings.theme.name + ("light" !== this.settings.style ? "-".concat(this.settings.style) : "")))
                                    );
                                else {
                                    var t = this._getSetting("Theme");
                                    this._insertStylesheet(
                                        "template-customizer-theme-css",
                                        this.pathResolver(this.settings.themesPath + this.settings.cssFilenamePattern.replace("%name%", t || "theme-default" + ("light" !== this.settings.style ? "-".concat(this.settings.style) : "")))
                                    );
                                }
                            },
                        },
                                ...
                                function o(t, e, s) {
                                    ...
                                    var a,
                                        ...
                                        l = setTimeout(function () {
                                            clearInterval(a), clearTimeout(l), e.parentNode.removeChild(i), s(!1, t);
                                        }, 15e3);
                                    (a = setInterval(function () {
                                        try {
                                            i[o] && i[o][n].length && (clearInterval(a), clearTimeout(l), e.parentNode.removeChild(e), s(!0));
                                        } catch (t) {}
                                    }, 10)),
                                        e.parentNode.insertBefore(i, e.nextSibling);
                                }
                                for (var n = 0; n < s.length; n++) o(s[n], t[s[n]], void ((a += 1) >= i && e()));
                            },
                        },
                        {
                            key: "_loadingState",
                        ...
                        },
                        {
                            key: "_getThemeByName",
                            value: function (t) {
                                for (var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], s = this.settings.availableThemes, i = 0, a = s.length; i < a; i++) if (s[i].name === t) return s[i];
