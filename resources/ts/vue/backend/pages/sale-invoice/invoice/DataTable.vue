<template>
    <div class="table-responsive text-nowrap">
        <table class="table">
            <caption class="ms-4">Sales Invoice</caption>
            <thead>
                <tr>
            ...
            <tbody>
                <tr v-for="(item, index) in desserts" :key="index">
                    ...
                    <td class="" style=""><div class="d-flex align-items-center">
                        <router-link :to="`/sales-invoice/invoice/edit/${item.slug}/${item.uid}`" class="text-body"><i class="ti ti-edit ti-sm me-2 text-primary"></i></router-link > |
