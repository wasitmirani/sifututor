<template>
    <!-- breadcrumb -->
    <breadcrumb :active_name="slug" :previous="[{ name: 'Tutor Payment', link: '/tutor/tutor-payment' }]">
    </breadcrumb>
    <!-- /breadcrumb -->
        ...
        <div class="col-xl-12 col-md-12 col-12 mb-md-0 mb-4">
            <div class="card invoice-preview-card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <router-link to="/tutor/tutor-payment"
...
export default {
    ...
    methods: {
        getTutorPayment(id) {
            axios.get('/tutor-list/' + id).then((res) => {
                this.form = res.data.products;
                this.edit_mode = true;
            }).catch((err) => {
                this.errors = err.response.data;
                this.$root.alertNotify(err.response.status, null, "error", err.response.data);
                this.$router.push('/tutor/tutor-payment');
            });
        }
    },
    mounted() {
