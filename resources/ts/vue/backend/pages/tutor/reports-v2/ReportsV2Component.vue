<template>
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            <h5 class="card-title">In App Student Reports</h5>
        </div>
    </div>
    <div class="card">
            ...
            <div class="d-flex justify-content-between align-items-center row pb-2 gap-3 gap-md-0">
                <div class="col-md-5 user_role">
                    <search-box class="ml-2" label="Search by tutor id"
                        :apiurl="'/report-v2?page=' + this.page_num" v-on:query="isQuery($event)"
                        v-on:loading="loadingStart($event)" v-on:reload="getReportV2()"
...
export default {
    ...
    methods: {
        getReportV2(page = 1) {
            this.loading = true;
            this.page_num = page;
            axios.get('/report-v2?page=' + page + '&query=' + this.query).then((res) => {
